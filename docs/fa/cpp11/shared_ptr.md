...
[شمارندهٔ داخلی shared_ptr چیست؟](#شمارنده-داخلی-shared_ptr-چیست)
...
[چرا getter از نوع shared_ptr می‌تواند مناسب باشد؟](#چرا-getter-از-نوع-shared_ptr-میتواند-مناسب-باشد)
...
[get() مالکیت را منتقل نمی‌کند](#get-مالکیت-را-منتقل-نمیکند)
[یک اشتباه بسیار خطرناک با raw pointer](#یک-اشتباه-بسیار-خطرناک-با-raw-pointer)
[آیا دسترسی به داخل shared_ptr باعث Memory Leak می‌شود؟](#آیا-دسترسی-به-داخل-shared_ptr-باعث-memory-leak-میشود)
[مشکل اصلی shared_ptr؛ چرخهٔ مالکیت](#مشکل-اصلی-shared_ptr-چرخه-مالکیت)
[چرا شمارندهٔ shared_ptr در این حالت به خوبی کار نمی‌کند؟](#چرا-شمارنده-shared_ptr-در-این-حالت-به-خوبی-کار-نمیکند)
...
[اگر فقط می‌خواهیم به object دسترسی بدهیم چه کنیم؟](#اگر-فقط-میخواهیم-به-object-دسترسی-بدهیم-چه-کنیم)
...
[آیا shared_ptr را می‌توان خالی کرد؟](#آیا-shared_ptr-را-میتوان-خالی-کرد)
